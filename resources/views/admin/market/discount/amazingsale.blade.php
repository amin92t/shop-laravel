...
@section('head-tag')
<title>کوپن های تخفیف شگفت انگیز</title>
@endsection
...
<section class="row">
    ...
    <section class="col-12 main-body-container">
        ...
        <section class="main-body-container-head">
            ...
            <h5>
                کوپن های تخفیف شگفت انگیز
            </h5>


        </section>
        <section class="d-flex justify-content-between align-items-center mb-3 border-bottom">
            <a href="{{route('admin.market.discount.amazingsaleCreate')}}" class="btn btn-info btn-sm">ایجاد کوپن تخفیف</a>
            <div>
