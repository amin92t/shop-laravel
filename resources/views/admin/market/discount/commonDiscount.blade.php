...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="#">تخفیف عمومی</a></li>
...
<section class="row">
    ...
    <section class="col-12 main-body-container">
        ...
        <section class="d-flex justify-content-between align-items-center mb-3 border-bottom">
            <a href="{{route('admin.market.discount.commonDiscountCreate')}}" class="btn btn-info btn-sm">ایجاد کوپن تخفیف</a>
            <div>
